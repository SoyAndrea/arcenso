...
- `arcenso_app()`: Launches a Shiny app to query and visualize available tables interactively.
...
Gomez Vargas, A., & Ciardullo, E. (2026). arcenso: Data from Argentina's Population Census. R package version 0.2.1. Available at: https://soyandrea.github.io/arcenso/
