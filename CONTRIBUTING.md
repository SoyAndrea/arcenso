...
This outlines how to propose a change to arcenso. For a detailed
...
This project is developed in Argentina, and we welcome contributions in
both **English** and **Spanish**.

- Issues: You are welcome to open new issues or comment on existing ones
  in either language.

- Pull Requests: You can submit and discuss PRs in Spanish or English.

- Code & Docs: While formal documentation and code comments are
  primarily in English to maintain global standards, do not let language
  be a barrier. Feel free to communicate in the language you feel most
  comfortable with, and we can work together on the final technical
  translation if needed.

Este proyecto se desarrolla en Argentina y aceptamos contribuciones
tanto en **inglés** como en **español**.

- Issues: Podés abrir nuevos hilos o comentar en los existentes en
  cualquiera de los dos idiomas.

- Pull Requests: Podés enviar y discutir propuestas de cambio (PRs) en
  español o inglés.

- Código y Docs: Aunque la documentación formal y los comentarios en el
  código se mantienen preferentemente en inglés por estándares globales,
  que el idioma no sea una barrera. Comunicate en el idioma que
  prefieras y, si es necesario, podemos trabajar juntos en la traducción
  técnica final.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("SoyAndrea/arcenso", fork = TRUE)`.
...
Code of
Conduct](https://soyandrea.github.io/arcenso/CODE_OF_CONDUCT.md). By
