...
- [`arcenso_gui()`](https://soyandrea.github.io/arcenso/reference/arcenso_gui.md):
  Launches a Shiny app to query and visualize available tables
  interactively.

- [`check_repository()`](https://soyandrea.github.io/arcenso/reference/check_repository.md):
  Reports the tables currently available in the package based on search
  criteria.

- [`get_census()`](https://soyandrea.github.io/arcenso/reference/get_census.md):
  Retrieves the actual datasets as a list of data frames.
...
our [Contributing
Guidelines](https://soyandrea.github.io/arcenso/CONTRIBUTING.md) for
more details.
